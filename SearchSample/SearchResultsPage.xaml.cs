...
namespace SearchSample
{
    ...
    public sealed partial class SearchResultsPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            var results = (e.Parameter as IEnumerable<object>).OfType<Movie>().Select(movie => new
                {
                    Title = movie.Title,
                    Image = movie.PosterURI
                }).Concat((e.Parameter as IEnumerable<object>).OfType<Actor>().Select(actor => new
                {
                    Title = actor.FullName,
                    Image = actor.PhotoURI
                }))
                .ToList();
